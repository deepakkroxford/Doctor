...
const addDoctor = async (req ,res)=>{
    ...
    try{
        ...
        {
            return res.json({success:false,message:'please enter a valid pssword'});
        }
...
//api for cancel the appointment from the admin section 
...
// api to get Dashboard data for adminpannel
