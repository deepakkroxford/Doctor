...
const registerUser = async (req, res) => {
    try {
        ...
        if (!validator.isEmail(email)) {
            return res.status(400).json({ success: false, message: 'please enter a valid emial' });
        }
...
const bookAppointment = async (req, res) => {
    try {
        ...
        const appointmentData = {
            ...
            userData,
            docData,
            amount: docData.fees, //replace with actual cost
            date: Date.now(), //replace with actual data
        }
...
// Api to get The userAppointment 
...
const verifyRozerpay = async (req,res)=>{
    try{
...
export { registerUser, loginUser, getProfile, updateProfile, bookAppointment, listAppointment, cancelAppointment, paymentRazorpay , verifyRozerpay}